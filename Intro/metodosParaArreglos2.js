...
console.log(nombres.indexOf('Gema')); // 5
...
/* 	
	📌 .forEach()  --> forEach((QUE, DONDE, TODO) => {})
...
/* 
	📌 .map()  ------> crear un nuevo array conteniendo el mismo numero de elementos del array original
...
/* 📌 .filter()    ------> crear un nuevo array solo delvuelve los resultados que cumplan con la condicion 
	Nos permite ejecutar una funcion por cada elemento 
